            ...
            t.registerPlugin(P, function (e) {
                ...
                return typeof e == Xt ? Y : (e.fn[d] = function () {
                    ...
                    t[R](r, function (e) {
                        ...
                        }}}, lr[C][$t] = {"top-left": {v: ot, h: M, side: M}, "top-right": {v: ot, h: T, side: T}, top: {v: ot, h: S, side: ot}, "top-center": {v: ot, h: S, side: ot}, "bottom-left": {v: N, h: M, side: M}, "bottom-right": {v: N, h: T, side: T}, bottom: {v: N, h: S, side: N}, "bottom-center": {v: N, h: S, side: N}, left: {v: S, h: M, side: M}, "center-left": {v: S, h: M, side: M}, right: {v: S, h: T, side: T}, "center-right": {v: S, h: T, side: T}, center: {v: S, h: S, side: Y}, "center-center": {v: S, h: S, side: Y}}, lr[C].on = function (e, t) {
                    this[un][e] || (this[un][e] = []), this[un][e].push(t)
                }, lr[C][u] = function (e) {
                    var t;
                    if (!this[un][e] || this[un][e][Q] == 0)
                        return;
                    ...
                    if (t.maxWidth != Et || t[L] == nt)
                        t[ht] = fr[ft](t[ht]), t._maxWidth = fr[ft](fr._[Lt](t.maxWidth)), t[ht] = Math.min(t[ht], t._maxWidth);
                    if (t.maxHeight != Et || t[tt] == nt)
                        t[z] = fr[cn](t[z]), t._maxHeight = fr[cn](fr._[Lt](t.maxHeight)), t[z] = Math.min(t[z], t._maxHeight);
                    ...
                    if (!t[f] || !(t[f]in this[$t]))
                        t[f] = "top-left";
                    t[Un] || (t[Un] = this[$t][t[f]][Un]);
                    if (!t[At] || typeof t[At] !== kn && !(t[At]in this[Ht]))
                        t[At] = vn;
                    t.clickToHide && r[Ut]("a")[x](Mt, Sn).on("click.skel-layers", function (t) {
                        var r, o, u = e(this);
                        if (u[Wt]("skel-layers-ignore"))
                            return;
                        t[tn](), t[Kt](), s[Yt]();
                        if (u[Wt]("skel-layers-ignoreHref"))
                            return;
                        ...
                        if (t[ct] && t.swipeToHide) {
                            ...
                            if (a)
                                return s[Qt] = V, s[Gt] = V, s[Yt](), Y
                        }
                        if (r[J]() == 0 && i < 0 || u > o - 2 && u < o + 2 && i > 0)
                            return Y
                    }), this[v] = r
                }, lr[C][Ot] = function () {
                    return this[v] !== V
                ...
                }, fr = {cache: {visibleWrapper: V, body: V, exclusiveLayer: V, document: V, html: V, htmlbody: V, hiddenWrapper: V, layers: {}, parent: V, window: V, wrapper: V}, config: {baseZIndex: 1e4, layers: {}, mode: f, speed: 500, easing: "ease", wrap: pt}, layerIndex: 1, create: function (t, i, s) {
                        var o, u;
                        if (t in fr[r][P])
                            return;
                        if (f in i) {
                                ...
                                for (s = 0; s < this[Q]; s++) {
                                    ...
                                    if (!o[h.id])
                                        if (d = lr[C][$t][p[vt](_t)]) {
                                            ...
                                            d = p[f](), o[h.id] = {top: d[ot], left: d[M]};
